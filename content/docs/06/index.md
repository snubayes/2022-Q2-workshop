...
&= \frac{1}{2} \sum_{i=1}^r \left\\{ \frac{1}{2^{r-1} |\Lambda| } \sum_{\rho_i = 0} \sum _ {\theta : \gamma(\theta) = \rho} \int _ \theta  \gamma_i(\theta^\prime)) d\mathbb{P}_ {\theta^\prime} + \frac{1}{2^{r-1} |\Lambda| } \sum_{\rho_i = 1} \sum _ {\theta : \gamma(\theta) = \rho} \int _ \theta  1 - \gamma_i(\theta^\prime)) d\mathbb{P}_ {\theta^\prime} \right\\} \\\\ 
&= \frac{1}{2} \sum_{i=1}^r \left\\{  \int _ \theta  \gamma_i(\theta^\prime)) \frac{1}{2^{r-1} |\Lambda| } \sum_{\rho_i = 0} \sum _ {\theta : \gamma(\theta) = \rho} d\mathbb{P}_ {\theta^\prime} + \int _ \theta  \left( 1 - \gamma_i(\theta^\prime)) \right) \frac{1}{2^{r-1} |\Lambda| } \sum_{\rho_i = 1} \sum _ {\theta : \gamma(\theta) = \rho} d\mathbb{P}_ {\theta^\prime} \right\\} \\\\ 
&= \frac{1}{2} \sum_{i=1}^r \left\\{  \int _ \theta  \gamma_i(\theta^\prime)) d \overline{\mathbb{P}} _ {i, 0} + \int _ \theta  \left( 1 - \gamma_i(\theta^\prime)) \right) d \overline{\mathbb{P}} _ {i, 0} \right\\} \\\\ 
